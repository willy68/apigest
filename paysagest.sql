...
-- -----------------------------------------------------
-- Data for table `paysagest`.`dernier_code`
-- -----------------------------------------------------
START TRANSACTION;
USE `paysagest`;
INSERT INTO `paysagest`.`dernier_code` (`id`, `table_nom`, `colonne`, `code_table`, `prochain_code`) VALUES (1, 'client', 'client_code', '0', '1');
INSERT INTO `paysagest`.`dernier_code` (`id`, `table_nom`, `colonne`, `code_table`, `prochain_code`) VALUES (2, 'devis', 'code_devis', '0', '1');
INSERT INTO `paysagest`.`dernier_code` (`id`, `table_nom`, `colonne`, `code_table`, `prochain_code`) VALUES (3, 'facture', 'code_facture', '0', '1');
INSERT INTO `paysagest`.`dernier_code` (`id`, `table_nom`, `colonne`, `code_table`, `prochain_code`) VALUES (4, 'contrat', 'code_contrat', '0', '1');

...
define('LIBRARY', dirname(__DIR__) . DIRECTORY_SEPARATOR);
...
/*
 ...
 Autoload for the ActiveRecord core library
...
spl_autoload_register(function($class)
{
	...
	{
		require LIBRARY . str_replace('\\', DIRECTORY_SEPARATOR, $class) . '.php';
		return;
	}
...
/*
 ...
 Autoload for the ActiveRecord Models

*/
spl_autoload_register(function($class)
{
	$paths = Config::instance()->get_model_directories();
	$namespace_directory = '';
	if (($namespaces = get_namespaces($class)))
	{
	...
	{
		$root = realpath($path);
		$file = "{$root}{$namespace_directory}".DIRECTORY_SEPARATOR."{$class}.php";
